...
import { Animated, StyleSheet, Image, FlatList, Dimensions, Modal, ScrollView } from 'react-native';
                ...
                {illustrations.map((item, index) => {
                    ...
                    return (
                        <Block
                            ...
                            key={`step-${index}`}
                            color='gray'
                            style={[styles.steps, { opacity }]}></Block>
                    )
                })}
            </Block>
        )
    ...
    renderTermsService() {
        return (
            <Modal animationType='slide' visible={this.state.showTerms}>
                <Block padding={[theme.sizes.padding]} space="between" >
                    <Text h2 light>
                        Terms and service
                        </Text>
        ...
        return < Block >
            ...
            <Block middle flex={0.5} margin={[0, theme.sizes.padding * 2]}>
                ...
                <Button onPress={() => this.setState({ showTerms: true })}>
                    <Text caption center semibold gray>
                        Term of service
                    </Text>
                </Button>
            </Block>
